 ...
 session_start();
		...
		if(isset($_GET['submit'])){
			...
			$pass=$_GET['password'];
				...
				$result = mysql_query("SELECT * FROM email where Email ='".$email."' AND password='".$pass."'");
				...
				<div class="container clearfix">
					...
					<div class="tabs divcenter nobottommargin clearfix" id="tab-login-register" style="max-width: 500px;">
                        ...
                        <ul class="tab-nav tab-nav2 center clearfix">
                            <li class="inline-block"><a href="#tab-login">Tailor Login</a></li>
                            <li class="inline-block"><a href="#tab-register">Tailor Register</a></li>
                        </ul>
                        ...
                        <div class="tab-container">
                            ...
                            <div class="tab-content clearfix" id="tab-login">
                                <div class="panel panel-default nobottommargin">
                                	<div class="panel-body" style="padding: 40px;">
                                		<form id="login-form" name="login-form" class="nobottommargin" action="#" method="get">

			                                <h4 class="center"> Welcome Back , <span> let's weave once again ! </span></h4>
			                                ...
			                                <div class="col_full nobottommargin">
			                                    <button type="submit" class="button button-3d button-black nomargin" id="login-form-submit" name="submit" value="login"></button>
                            ...
                            <div class="tab-content clearfix" id="tab-register">
                                <div class="panel panel-default nobottommargin">
                                	<div class="panel-body" style="padding: 40px;">
                                		  <h4 class="center"> Hello, <span> It is time to showcase your design !</span></h4>
                                		<form id="register-form" name="register-form" class="nobottommargin" action="tailor-register.php" method="post">

				                            <div class="col_full">
				                                <label for="register-form-name">Name:</label>
				                                <input type="text" id="register-form-name" name="name" value="" class="form-control" required/>
				                            </div>
				                            ...
				                            <div class="col_full">
				                                ...
				                                <input type="password" id="register-form-repassword" name="repassword" value="" class="form-control" required />
				                            </div>

				                            <div class="col_full nobottommargin">
				                                <button class="button button-3d button-black nomargin" id="register-form-submit" name="submit" value="">Register Now</button>
				                            </div>
